...
export default function Testimonial({ name, result, text, photoURL }) {
  return (
    <div className="flex flex-col w-[39%] max-md:ml-0 max-md:w-full relative">
      <div className="min-h-[420px] flex flex-col items-start px-10 py-14 mx-auto w-full bg-white rounded-3xl border border-indigo-700 border-solid max-md:px-5 max-md:mt-10 max-md:max-w-full">
